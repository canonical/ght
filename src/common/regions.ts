...
export const regions: { [key: string]: string[] } = {
    americas: [
        ...
        "Home based - Americas, Laval",
        "Home based - Americas, Sherbrooke",
        "Home based - Americas, Trois-Rivieres",
        "Home based - Americas, Gatineau",
        "Home based - Americas, Ottawa",
        "Home based - Americas, Toronto",
        "Home based - Americas, Mississauga",
        "Home based - Americas, Hamilton",
        "Home based - Americas, Sudbury",
        "Home based - Americas, Moncton",
        "Home based - Americas, Winnipeg",
        "Home based - Americas, Regina",
        "Home based - Americas, Edmonton",
        "Home based - Americas, Calgary",
        "Home based - Americas, Saint John",
        "Home based - Americas, St. John's",
